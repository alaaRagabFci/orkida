                    ...
                    <form id="form_sample_1" class="form-horizontal" enctype="multipart/form-data" method="post" action="{{ url('adminpanel/blogs/'.$blog->id) }}" data-toggle="validator">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <textarea rows="2" cols="30" name="description_ar" class="form-control ckeditor" required>{{ $blog->description_ar }}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" value="{{ $blog->keywords }}" name="keywords" required class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
