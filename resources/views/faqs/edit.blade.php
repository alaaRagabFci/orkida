        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                ...
                <div class="portlet-body">
                    ...
                    @endif
                    <!-- BEGIN FORM-->
                    <form id="form_sample_1" class="form-horizontal" enctype="multipart/form-data" method="post" action="{{ url('adminpanel/faqs/'.$faq->id) }}" data-toggle="validator">
                        <div class="form-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab_1_1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" value="{{ $faq->slug_ar }}" name="slug_ar" required class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane" id="tab_1_2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" value="{{ $faq->slug_en }}" name="slug_en" required class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input data-onstyle="danger" @if($faq->is_common) ? checked : "" @endif type="checkbox" name="is_common"  data-toggle="toggle">
                                    </div>
                                </div>
                                <div class="form-group">
