                        ...
                        <div class="form-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab_1_1">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" value="{{ $service->name_ar }}" name="name_ar" required class="form-control input-lg">
                                    </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <textarea rows="3" cols="53" name="slug_ar" class="" required>{{ $service->slug_ar }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3">الكلمة الأفتتاحيه</label>
                                        <div class="col-md-4">
                                            <textarea rows="3" cols="53" name="keywords_ar" class="" required>{{ $service->keywords_ar }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Meta title ar</label>
                                        <div class="col-md-4">
                                            <textarea rows="3" cols="53" name="meta_title_ar" class="" required>{{ $service->meta_title_ar }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <textarea rows="3" cols="53" name="meta_description_ar" class="" required>{{ $service->meta_description_ar }}</textarea>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane" id="tab_1_2">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" value="{{ $service->name_en }}" name="name_en" required class="form-control input-lg">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <textarea rows="3" cols="53" name="slug_en" class="" required>{{ $service->slug_en }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3">الكلمة الأفتتاحيه</label>
                                        <div class="col-md-4">
                                            <textarea rows="3" cols="53" name="keywords_en" class="" required>{{ $service->keywords_en }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Meta title en</label>
                                        <div class="col-md-4">
                                            <textarea rows="3" cols="53" name="meta_title_en" class="" required>{{ $service->meta_title_en }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <textarea rows="3" cols="53" name="meta_description_en" class="" required>{{ $service->meta_description_en }}</textarea>
                                        </div>
                                    </div>
