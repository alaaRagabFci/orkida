                    ...
                    <form id="form_sample_1" class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{ url('adminpanel/services') }}" data-toggle="validator">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                <input type="text" value="{{ old('image_title') }}" name="image_title" required class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                <textarea rows="2" value="{{ old('image_alt') }}" cols="30" name="image_alt" class="form-control" required>{{ old('image_alt') }}</textarea>
                                </div>
                            </div>
