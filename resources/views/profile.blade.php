            ...
            <div class="profile-sidebar">
                ...
                <div class="portlet light profile-sidebar-portlet bordered">
                    ...
                    <div class="profile-usertitle">
                        ...
                        <div class="profile-usertitle-job"> الأدارة </div>
                    </div>
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title tabbable-line">
                                <div class="caption caption-md">
                                    ...
                                    <span class="caption-subject font-blue-madison bold uppercase">تعديل بيناتك الشخصية</span>
                                </div>
                                <ul class="nav nav-tabs">
                                    ...
                                    <li>
                                        <a href="#tab_1_2" data-toggle="tab">صورة البروفايل</a>
                                    </li>
                                    <li>
                                        <a href="#tab_1_3" data-toggle="tab">الرقم السري</a>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <div class="tab-pane active" id="tab_1_1">
                                        <form role="form" action="{{ url('adminpanel/updateProfile') }}" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" required name="name" value="{{ $info['user']->name }}" placeholder="John" class="form-control" /> </div>
                                            <div class="form-group">
                                                <label class="control-label">البريد الألكتروني</label>
                                                <input type="email" required name="email" value="{{ $info['user']->email }}" placeholder="email" class="form-control" /> </div>
