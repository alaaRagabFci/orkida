...
<html lang="en" dir="rtl">
    ...
    <head>
        ...
        <meta content="أوركيدا لمكافحة الحشرات " name="description" />
    ...
    <body class=" login" style="background-color: #fff !important;">
        ...
        <div class="logo" style="margin: 16px auto 0">
                <img src="{{ asset('/admin_ui/logo.png')}}" style="width: 200px;" alt="" />
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content" style="background-color: #792779 !important;">
            <!-- BEGIN LOGIN FORM -->
        ...
        <div class="copyright"> 2020 © OrkidaPest </div>
        <!--[if lt IE 9]>
