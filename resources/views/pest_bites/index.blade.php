...
@section('title','أنواع لدغات الحشرات')
    ...
    <div class="portlet light bordered">
      <div class="portlet-title">
        <div class="caption font-green-haze">
          ...
          <span class="caption-subject bold uppercase">أنواع لدغات الحشرات</span>
        </div>
        <div class="tools"> </div>
      </div>
      <div class="portlet-body">
          <div class="table-toolbar">
                      ...
                      <div class="btn-group">
                          <a href="{{ url('/adminpanel/'.$modal.'/create') }}">
                              <button  data-toggle="modal" id="sample_editable_1_new" class="btn btn-primary">
                                  أضافة لدغه جديدة <i class="fa fa-plus"></i>
                              </button>
                          </a>
                      </div>
                  </div>
              ...
              <table class="table table-striped table-bordered table-hover table-header-fixed" id="bites">
                <thead>
                <th class="col-md-1">الصورة</th>
                <th class="col-md-1">نوع الحشرة</th>
            ...
            $(document).ready(function() {
                oTable = $('#bites').DataTable({
                    ...
                    "columns": [
                        ...
                        {data: 'pest_type_ar', name: 'pest_type_ar'},
