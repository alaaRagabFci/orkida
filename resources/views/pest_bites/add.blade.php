                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab_1_1">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" value="{{ old('sting_appearance_ar') }}" name="sting_appearance_ar" required class="form-control input-lg">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    <label class="control-label col-md-3">نوع الحشرة</label>
                                    <div class="col-md-8">
                                        <input type="text" value="{{ old('pest_type_ar') }}" name="pest_type_ar" required class="form-control input-lg">
                                    </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3">الأعراض</label>
                                        <div class="col-md-8">
                                            <textarea rows="3" cols="30" name="insect_bites_ar" class="form-control" required>{{ old('insect_bites_ar') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="tab-pane" id="tab_1_2">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" value="{{ old('sting_appearance_en') }}" name="sting_appearance_en" required class="form-control input-lg">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Pest type</label>
                                        <div class="col-md-8">
                                            <input type="text" value="{{ old('pest_type_en') }}" name="pest_type_en" required class="form-control input-lg">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Insects</label>
                                        <div class="col-md-8">
                                            <textarea rows="3" cols="30" name="insect_bites_en" class="form-control" required>{{ old('insect_bites_en') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
